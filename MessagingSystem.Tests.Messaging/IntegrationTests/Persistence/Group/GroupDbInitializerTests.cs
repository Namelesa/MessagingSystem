...
{
    public class GroupDbInitializerTests : IAsyncLifetime
    {
        ...
        private GroupAppDbContext CreateDbContext()
        {
        ...
        public async Task Initialize_WhenDatabaseHasPendingMigrations_ShouldApplyMigrations()
        {
            ...
            var logger = new TestLogger<Services.Messaging.Persistence.Group.GroupDbInitializer.GroupDbInitializer>();
            var initializer = new Services.Messaging.Persistence.Group.GroupDbInitializer.GroupDbInitializer(context, logger);
        ...
        public async Task Initialize_WhenMigrationThrows_ShouldLogInformation()
        {
            ...
            var options = new DbContextOptionsBuilder<GroupAppDbContext>()
                ...
                .Options;
            await using var context = new GroupAppDbContext(options);
            var logger = new TestLogger<Services.Messaging.Persistence.Group.GroupDbInitializer.GroupDbInitializer>();
            var initializer = new Services.Messaging.Persistence.Group.GroupDbInitializer.GroupDbInitializer(context, logger);
