...
namespace MessagingSystem.Services.Messaging.Application.Group.GroupMessages.Validators;

public class GroupMessageCreateValidator : AbstractValidator<GroupMessageDto>
{
    public GroupMessageCreateValidator()
    {
        RuleFor(u => u.Sender)
        ...
        RuleFor(u => u.GroupId)
            ...
            .Must(g => g != Guid.Empty).WithMessage("Group ID must be a valid GUID.");
    }
}