...
namespace MessagingSystem.Tests.User.IntegrationTests.Infrastructure.DbInitializer
{
    public class DbInitializerTests : IAsyncLifetime
    {
        ...
        public async Task Initialize_WhenDatabaseHasPendingMigrations_ShouldApplyMigrations()
        {
            ...
            var logger = new TestLogger<Services.User.Persistence.DbInitializer.DbInitializer>();
            var initializer = new Services.User.Persistence.DbInitializer.DbInitializer(context, logger);
